...
import com.inarosdev.level.XPTable;

import javax.annotation.Nonnull;

public class RxpStatsCommand extends AbstractPlayerCommand {

    public RxpStatsCommand() {
    ...
    protected void execute(
        ...
        if (rpg == null) {
            playerRef.sendMessage(Message.raw("No RXP data found"));
            return;
        }
        ...
        playerRef.sendMessage(Message.raw("=== RXP Stats ==="));
